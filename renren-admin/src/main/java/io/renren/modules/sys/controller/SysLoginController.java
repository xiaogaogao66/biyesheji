...
public class SysLoginController {
    ...
    public R register(@RequestBody SysUserVO userVO) {
        ValidatorUtils.validateEntity(userVO, RegisterGroup.class);
        String kaptcha = ShiroUtils.getKaptcha(Constants.KAPTCHA_SESSION_KEY);
        if (!userVO.getCaptcha().equalsIgnoreCase(kaptcha)) {
        ...
        userEntity.setRoleIdList(Collections.singletonList(2L));
